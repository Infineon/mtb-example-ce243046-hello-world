# PSOC&trade; Control C1: Hello world
...
[View this README on GitHub.](https://github.com/Infineon/mtb-example-ce243046-hello-world)

[Provide feedback on this code example.](https://yourvoice.infineon.com/jfe/form/SV_1NTns53sK2yiljn?Q_EED=)
...
The following example clones the "[Hello World](https://github.com/Infineon/mtb-example-ce243046-hello-world)" application with the desired name "HelloWorld" configured for the *KIT_PSC1M3_EVK* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSC1M3_EVK --app-id mtb-example-ce243046-hello-world --user-app-name HelloWorld --target-dir "C:/mtb_projects"
   ```
...
4. After programming, the application starts automatically. Confirm that "PDL: Hello World! Example" is displayed on the UART terminal
...
Document title: *CE243046* – *PSOC&trade; Control C1: Hello world*
